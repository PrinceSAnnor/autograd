...
void draw() //runs forever
{
  ...
  stroke(0,0,255); //sets the color of the outline of the shapes drawn below this code below blue 
  ...
  fill(255,0,0); //sets the color of shapes drawn below the code light red
  ellipse(640, 360, 50, 50); //draws an ellipse
  
  textSize(50); //set text size to 20
  
  fill(255,255,255); //sets the color of the text drawn below this code white
