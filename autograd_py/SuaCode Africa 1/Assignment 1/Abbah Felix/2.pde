...
void draw() //runs continuously until the program is stopped 
{
 ...
 fill (0,0,255);// set paddle as Blue 
 ...
 stroke (0);// set stroke as black 
 
 fill(255,255,255);// set ellipse as white 

 ellipse (512,300,45,45);// shape of the ellipse ball
 ...
 fill(255,0,0);// set the color of scores red
 
 text(0,350,300);// 1st Score 
 
 text(9,650,300);// 2nd Score 
